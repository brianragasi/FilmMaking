(() => {
  ...
  function applyState(nextState) {
    ...
    // Keep an already-open customer screen in place. A real refresh requests
    // PHP again and reveals the server-error page, matching the filmed action.
    if (customerView && view === 'outage' && state.cue !== 'outage') {
