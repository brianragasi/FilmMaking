            ...
            <div class="app-shell-narrow py-5 sm:py-8">
                ...
                <div class="grid gap-7 lg:grid-cols-[minmax(0,1.05fr)_minmax(400px,0.95fr)] lg:gap-12">
                    ...
                    <div class="flex min-w-0 flex-col justify-center py-1">
                        ...
                        <div class="mt-6 flex flex-wrap items-end justify-between gap-3 border-y border-slate-100 py-5"><div><div class="flex items-center gap-2"><p class="text-[10px] font-black uppercase text-slate-400">Big Blowout price</p><span class="rounded bg-rose-600 px-2 py-1 text-[10px] font-black uppercase text-white"><?= product_discount_percentage($product) ?>% off</span></div><div class="mt-2 flex flex-wrap items-end gap-2"><p class="text-3xl font-black text-rose-600"><?= peso((float) $product['price']) ?></p><p class="pb-1 text-sm font-bold text-slate-400 line-through"><?= peso(product_regular_price($product)) ?></p></div><p class="mt-1 text-xs font-black text-emerald-700">You save <?= peso(product_savings($product)) ?></p></div><p class="rounded bg-slate-100 px-3 py-2 text-xs font-bold text-slate-600"><?= (int) $product['stock'] ?> available</p></div>
